 ...
 ***************************************************************/
 ...
 /**
 * CollectionValidator override
 *
 * Fixes the 8.7.5 issue where Error results are reset because a child property of the same object
 * as the parent object receives the same instance of CollectionValidator
 *
 ...
 *
 */
class CollectionValidator extends \TYPO3\CMS\Extbase\Validation\Validator\CollectionValidator {
