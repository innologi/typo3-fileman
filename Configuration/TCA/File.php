...
$TCA['tx_fileman_domain_model_file'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, file_uri, alternate_title, description, category, links, fe_user', #@LOW currently unused: link_names,
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, file_uri, alternate_title, description, category,
			links, fe_user,
			--div--;LLL:EXT:cms/locallang_ttc.xml:tabs.access,starttime,endtime'), #@LOW currently unused: --palette--;LLL:EXT:fileman/Resources/Private/Language/locallang_db.xml:tx_fileman_domain_model_file.palette.linkcombo;linkcombo,
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
